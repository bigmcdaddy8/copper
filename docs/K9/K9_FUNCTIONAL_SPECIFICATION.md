...
| entry order cancellation confirmed | broker confirms entry order has been cancelled | 'K9' records cancellation; if `max_entry_attempts` not exceeded, submit a new entry order with adjusted price; otherwise mark trade as abandoned for the day |
